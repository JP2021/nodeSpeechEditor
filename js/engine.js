      ...
      placeholder: 'Digite o conteúdo do auto texto....'
        ...
        function toggleRecording() {
            if (!isRecording) {
                iniciarGravacao();
                isRecording = true;
                document.getElementById('record-btn').innerHTML = '<img src="./assets/img/pause.jpg" alt="Pausar" width="30">';
            } else {
                pararGravacao();
                isRecording = false;
        ...
        function iniciarGravacao() {
            ...
            recognition.onresult = function(event) {
                ...
                if (transcript.trim() || newLine || newParagraph) {
                    ...
                    if (newLine) quill.insertText(index++, '\n', 'user');
                    if (newParagraph) quill.insertText(index, '\n\n', 'user'), index += 2;
        ...
        function aplicarCorrecaoNoEditor() {
            ...
            const textoCorrigido = corrigirEspacosAntesDePontos(textoAtual);
            quill.setText(textoCorrigido);
